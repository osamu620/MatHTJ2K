% J2K_BLOCK_ENCODER_V_SCRIPT   Generate MEX-function j2k_block_encoder_v_mex
%  from j2k_block_encoder_v.
%
% Script generated from project 'j2k_block_encoder_v.prj' on 23-Jul-2020.
%
...
%% Define argument types for entry-point 'j2k_block_encoder_v'.
ARGS = cell(1, 1);
ARGS{1} = cell(3, 1);
...
ARGS{1}{1}.Properties.compressed_data = coder.typeof(uint8(0), [1, 32768], [0, 1]);
...
ARGS{1}{1}.Properties.pass_idx = coder.typeof(int32(0));
